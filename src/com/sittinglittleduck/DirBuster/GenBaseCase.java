...
public class GenBaseCase
{
    ...
    public static synchronized BaseCase genBaseCase(String url, boolean isDir, String fileExtention) throws MalformedURLException, IOException
    {
        ...
        else
        {
             ...
             */
            //System.out.println("GEN CASE: "  + url + failString + fileExtention);
            failurl = new URL(url + failString + fileExtention);
        }
        ...
        if(failcode == 200)
        {
            ...
            baseResponce = FilterResponse.cleanResponce(baseResponce, failurl, failString);
            ...
            String baseResponce2 = getBaseCaseAgain(new URL(url + failString + "2" + fileExtention), failString + "2");
            String baseResponce3 = getBaseCaseAgain(new URL(url + failString + "3" + fileExtention), failString + "3");
