    ...
    public static void test(String url)
    {
        ...
        if(manager.getAuto())
        {
            try
            {
                ...
                {
                    /*
                     * now perform a get requests and check that they came back the same!
                     */
                    GetMethod httpget = new GetMethod(headurl.toString());
                     ...
                     * perfom the test
                     */
                    if(responceCode != httpclient.executeMethod(httpget))
                    {
                        manager.setAuto(false);
                    }
