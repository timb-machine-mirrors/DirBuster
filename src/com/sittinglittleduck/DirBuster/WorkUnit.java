...
public class WorkUnit
{
    ...
    /*
     * Stores the required response expected on a nikto request
     * Add to help remove false positives!
     */
    private int niktoRequiredResponse = -1;
    ...
    public WorkUnit(URL url, boolean isDir, String method, BaseCase baseCaseObj, String itemToCheck, int niktoRequiredResponse)
    {
        urlToGet = url;
        this.isDir = isDir;
        this.method = method;
        this.baseCaseObj = baseCaseObj;
        this.itemToCheck = itemToCheck;
        this.niktoRequiredResponse = niktoRequiredResponse;
    }
    ...
    public int getNiktoRequiredResponse()
    {
        return niktoRequiredResponse;
    }
