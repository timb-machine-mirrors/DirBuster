...
public class JDialogAdvSetup extends javax.swing.JDialog
{
    ...
    public JDialogAdvSetup(java.awt.Frame parent, boolean modal)
    {
        ...
        /*
         * set the text field for the location of the nikto files
         */
        jTextFieldNiktoLocation.setText(manager.getNiktoFileLocation());

        /*
         * set the should we run default file scanning by default
         */
        jCheckBoxDefaultFileEnable.setSelected(manager.getEnableNiktoByDefault());

        /*
         * set the enable Recursive by default
         */
        jCheckBoxEnableRecursiveByDefault.setSelected(manager.getEnableRecursiveByDefault());
    }
    ...
    private void initComponents() {
        ...
        jPanelHTTPOpts = new javax.swing.JPanel();
        ...
        jCheckBoxEnableRecursiveByDefault = new javax.swing.JCheckBox();
        jPanelDirBusterOptions = new javax.swing.JPanel();
        ...
        jPanelDefaultScansOpts = new javax.swing.JPanel();
        jLabel28 = new javax.swing.JLabel();
        jTextFieldNiktoLocation = new javax.swing.JTextField();
        jButtonNiktoFileBrowse = new javax.swing.JButton();
        jCheckBoxDefaultFileEnable = new javax.swing.JCheckBox();
                ...
                .add(jPanelHTMLParseLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanelHTMLParseLayout.createSequentialGroup()
                        .add(jPanelHTMLParseLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jSeparator3, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 585, Short.MAX_VALUE)
        ...
        org.jdesktop.layout.GroupLayout jPanelHTTPOptsLayout = new org.jdesktop.layout.GroupLayout(jPanelHTTPOpts);
        jPanelHTTPOpts.setLayout(jPanelHTTPOptsLayout);
        jPanelHTTPOptsLayout.setHorizontalGroup(
            jPanelHTTPOptsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jPanelHTTPOptsLayout.createSequentialGroup()
                .addContainerGap()
                .add(jPanelHTTPOptsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jScrollPane1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jSeparator1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE)
                    .add(jLabel11)
                    .add(jCheckBoxRunViaProxy, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 160, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jCheckBoxUseProxyAuth, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 170, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    ...
                    .add(jPanelHTTPOptsLayout.createSequentialGroup()
                        ...
                        .add(280, 280, 280))
                    .add(jLabel3, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE)
                    .add(jTextFieldUserAgent, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jSeparator5, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE)
        ...
        jPanelHTTPOptsLayout.setVerticalGroup(
            jPanelHTTPOptsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jPanelHTTPOptsLayout.createSequentialGroup()
                .addContainerGap()
                .add(jLabel1)
                ...
                .add(jLabel2)
                .add(5, 5, 5)
                .add(jPanelHTTPOptsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
        ...
        jTabbedPane1.addTab("Http Options", jPanelHTTPOpts);
        ...
        jCheckBoxEnableRecursiveByDefault.setText("Enable recursive scanning by default");
        ...
        jPanelScanOptsLayout.setHorizontalGroup(
            ...
            .add(jPanelScanOptsLayout.createSequentialGroup()
                ...
                .add(jPanelScanOptsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jCheckBoxEnableRecursiveByDefault)
                    .add(jPanelScanOptsLayout.createSequentialGroup()
                        .add(21, 21, 21)
                    ...
                    .add(jSeparator4, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE)
                    .add(jCheckBoxLimitReqSec)
                    .add(jPanelScanOptsLayout.createSequentialGroup()
                        .add(jPanelScanOptsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                    ...
                    .add(jSeparator7, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jTabbedPane1.addTab("Scan Options", jPanelScanOpts);
        ...
        org.jdesktop.layout.GroupLayout jPanelDirBusterOptionsLayout = new org.jdesktop.layout.GroupLayout(jPanelDirBusterOptions);
        jPanelDirBusterOptions.setLayout(jPanelDirBusterOptionsLayout);
        jPanelDirBusterOptionsLayout.setHorizontalGroup(
            jPanelDirBusterOptionsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jPanelDirBusterOptionsLayout.createSequentialGroup()
                .addContainerGap()
                .add(jPanelDirBusterOptionsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jSeparator6, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 587, Short.MAX_VALUE)
                    ...
                    .add(jPanelDirBusterOptionsLayout.createSequentialGroup()
                        ...
                        .add(jPanelDirBusterOptionsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanelDirBusterOptionsLayout.createSequentialGroup()
                                .add(jTextFieldDefaultList, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 380, Short.MAX_VALUE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jButton1))
                            .add(jTextFieldDefaultExts, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 473, Short.MAX_VALUE))))
                .addContainerGap())
        );
        jPanelDirBusterOptionsLayout.setVerticalGroup(
            jPanelDirBusterOptionsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jPanelDirBusterOptionsLayout.createSequentialGroup()
                .addContainerGap()
                .add(jCheckBoxAllowUpdates)
                ...
                .add(jLabel12)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                .add(jPanelDirBusterOptionsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel10)
        ...
        jTabbedPane1.addTab("DirBuster Options", jPanelDirBusterOptions);

        jLabel28.setText("The directory containing the Nikto database file");

        jButtonNiktoFileBrowse.setText("Browse");
        jButtonNiktoFileBrowse.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonNiktoFileBrowseActionPerformed(evt);
            }
        });

        jCheckBoxDefaultFileEnable.setText("Enable by default");

        org.jdesktop.layout.GroupLayout jPanelDefaultScansOptsLayout = new org.jdesktop.layout.GroupLayout(jPanelDefaultScansOpts);
        jPanelDefaultScansOpts.setLayout(jPanelDefaultScansOptsLayout);
        jPanelDefaultScansOptsLayout.setHorizontalGroup(
            jPanelDefaultScansOptsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jPanelDefaultScansOptsLayout.createSequentialGroup()
                .addContainerGap()
                .add(jPanelDefaultScansOptsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jCheckBoxDefaultFileEnable)
                    .add(jPanelDefaultScansOptsLayout.createSequentialGroup()
                        .add(jTextFieldNiktoLocation, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 307, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jButtonNiktoFileBrowse))
                    .add(jLabel28))
                .addContainerGap(217, Short.MAX_VALUE))
        );
        jPanelDefaultScansOptsLayout.setVerticalGroup(
            jPanelDefaultScansOptsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jPanelDefaultScansOptsLayout.createSequentialGroup()
                .add(21, 21, 21)
                .add(jLabel28)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanelDefaultScansOptsLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jTextFieldNiktoLocation, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jButtonNiktoFileBrowse))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                .add(jCheckBoxDefaultFileEnable)
        ...
        jTabbedPane1.addTab("Default File Scanning", jPanelDefaultScansOpts);
    ...
    {//GEN-HEADEREND:event_jButtonOkActionPerformed
        ...
        /*
         * save the nitkto file location
         */

        manager.setNiktoFileLocation(jTextFieldNiktoLocation.getText());
        
        /*
         * Save if we should enable nikto file scanning by default
         */
        manager.setEnableNiktoByDefault(jCheckBoxDefaultFileEnable.isSelected());

        /*
         * save the Recursive by default setting
         */
        manager.setEnableRecursiveByDefault(jCheckBoxEnableRecursiveByDefault.isSelected());
...
private void jButtonNiktoFileBrowseActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jButtonNiktoFileBrowseActionPerformed
{//GEN-HEADEREND:event_jButtonNiktoFileBrowseActionPerformed
    File dir = new File(System.getProperty("user.dir"));
    JFileChooser fc = new JFileChooser(dir);
    fc.setDialogTitle("Please Select The Directory Where The Nikto Files Are");
    fc.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
    int returnVal = fc.showDialog(this, "Select Dir");
    if(returnVal == JFileChooser.APPROVE_OPTION)
    {
        File file = fc.getSelectedFile();
        jTextFieldNiktoLocation.setText(file.getAbsolutePath());
    }
}//GEN-LAST:event_jButtonNiktoFileBrowseActionPerformed
    ...
    private javax.swing.JButton jButtonNiktoFileBrowse;
    private javax.swing.JButton jButtonOk;
    private javax.swing.JCheckBox jCheckBoxAllowUpdates;
    private javax.swing.JCheckBox jCheckBoxDefaultFileEnable;
    private javax.swing.JCheckBox jCheckBoxEnableRecursiveByDefault;
    ...
    private javax.swing.JPanel jPanelDefaultScansOpts;
    private javax.swing.JPanel jPanelDirBusterOptions;
    private javax.swing.JPanel jPanelHTMLParse;
    private javax.swing.JPanel jPanelHTTPOpts;
    ...
    private javax.swing.JTextField jTextFieldNiktoLocation;
