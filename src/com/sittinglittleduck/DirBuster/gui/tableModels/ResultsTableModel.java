...
public class ResultsTableModel extends DefaultTableModel
{
    ...
    String[] columnNames = { new String("Type"), new String("Found"), new String("Response"), new String("Base Case"), new String("Size")};
   ...
   // }
    ...
    public Object getValueAt(int row, int col)
    {
        ...
        {
            return data.get(row).getItemFound().getFile();
        }
        else if (col==2)
        {
        ...
        {
            return data.get(row).getBaseCaseObj().getFailCode();
        }
        else if(col == 4)
        {
