...
public class JDialogViewReport extends javax.swing.JDialog
{
    ...
    public JDialogViewReport(java.awt.Frame parent, boolean modal, String saveLoc)
    {
        ...
        try
        {
            BufferedReader d = new BufferedReader(new FileReader(saveLoc + ".txt"));
        ...
        try
        {
           BufferedReader d = new BufferedReader(new FileReader(saveLoc + "-simple.txt"));
        ...
        try
        {
            BufferedReader d = new BufferedReader(new FileReader(saveLoc + ".xml"));
            ...
            jTextAreaXMLReport.setText(filebuf.toString());
        }
        catch(FileNotFoundException ex)
        {
        ...
        try
        {
            BufferedReader d = new BufferedReader(new FileReader(saveLoc + ".csv"));
            ...
            jTextAreaCSVReport.setText(filebuf.toString());
        }
        catch(FileNotFoundException ex)
        {
