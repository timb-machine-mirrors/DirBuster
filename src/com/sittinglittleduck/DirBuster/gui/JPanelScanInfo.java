...
public class JPanelScanInfo extends javax.swing.JPanel
{
    ...
    public JPanelScanInfo(int ThreadId, int type, int totalToCreate)
    {
        this.type = type;
        ...
        if(type == Manager.LIST_BASED)
        {
            ...
            jProgressBar1.setMaximum(totalToCreate);
            ...
            else if(gen.getType() == 2)
            {
                
                jLabelText.setText("Testing for default files with nikto database");
            }
    ...
    public void setProgressCurrentValue(int value)
    {
        ...
        //TODO: move this so each panel can have a different figure
        jProgressBar1.setMaximum(totalToCreate);
        ...
        {
            jProgressBar1.setMaximum(totalToCreate);
            jProgressBar1.setValue(totalToCreate);
        ...
        else
        {
            ...
            {
                    float percent = ((float) value / (float) totalToCreate) * 100f;


                    //System.out.println("value: " + value + " total: " + totalToCreate + " %" + ((value / totalToCreate)* 100f) + " test " + percent);
                    //System.out.println("test devide 1/2 * 100 = " + ((1/2) * 100) );
                    jProgressBar1.setString((int) percent + "%");
            }
