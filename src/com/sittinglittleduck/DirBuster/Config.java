...
public class Config
{
     ...
     * 1.0
     *
     * Removed redundent buttons in the found list menu
     * Small inprovments to the scan info pane
     * Task information is now shown in the tab header
     * Detects if a url is already in the clip board, if so allows the user to use it as the target
     * Improved false positive prevention
     * Imrpoved detection of servers that return different responses for head and get requests
     * Checks that java 1.6 is being used, exits if it is not
     * Fixed XML reporting bug submitted by Jabra.
     * Improvements to the setup interface to reduce size and number of compoents
     * Improved the reporting output code to more efficent
     * Fixed a small bug in the response view panel
     *
     * 1.0-RC1
